...
function WelcomeHome() {
    return (
        <div className="relative w-full h-[520px] md:h-[700px] overflow-hidden flex flex-row justify-between items-center">
            {/* TEXT */}
            <div className="relative z-20 mr-8 px-5 md:px-16 py-10 flex flex-col justify-center items-start gap-y-4 xl:pl-30">
                <div className="">
                    ...
                    <h1 className="text-green-400 font-bold my-4 text-3xl md:text-4xl lg:hidden h-full">
                        <Typewriter
                            onInit={(typewriter) => {
                                typewriter
                                    .typeString("Join Our Tennis Club")
                    ...
                    <h1 className="hidden lg:flex text-green-400 font-bold my-4 text-3xl md:text-4xl">
                        Join Our Tennis Club
                    </h1>
                </div>

                <div className="text-lg font-semibold md:text-2xl text-gray-100 max-w-xl mb-6 lg:text-black h-full">
                    <SlowlyShow text="We invite you to join us in this journey. The court is set, the ball is in your court. Come be a part of TENNIS NET Club." />
                </div>

                <div className="flex flex-col gap-y-4">
                    <Link href="/authentication/signup" className={buttonVariants({ variant: "outline" })}>
                        Become Member &rarr;
                    </Link>
                    <Link href="/" className={buttonVariants({ variant: "outline" })}>
                        Contact Us
